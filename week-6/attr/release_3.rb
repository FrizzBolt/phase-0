...
The setter method for returning age has been deleted and a new attribute writer has
appeared right under the attribute reader.


What was replaced?

The setter method for writing to the age variable has been replaced by the attribute writer.
The one line of code for the attribute writer performs in exactly the same way as the setter
method.


Is this code simpler than the last? 

Once again, yes. This is much simpler.
