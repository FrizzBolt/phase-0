...
There is now an attribute reader on the top of the screen and the getter method that
returned the profile's age has been replaced.

What was replaced?

In this release, the getter method that returned the age has been replaced by an attribute
reader. This single line of code at the top can be set to replace several getter methods.
By adding the attribute reader at the top, the coder received the exact same results with
much less work and DRY code.

Is this code simpler than the last?  
 
Yes. This significantly reduces the amount of necessary code and keeps everything DRY.
