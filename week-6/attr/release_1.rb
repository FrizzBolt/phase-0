...
The @what_is methods are getter methods that are set to their corresponding instance variables. They allow the coder
to access the value of an instance variable that is stored within the instance of the profile, but do not allow 
them to alter the information. 

The #change_my methods are setter methods. They allow the coder to access the information stored in the variable
and change them within the instance.

The #sleep methods make for a dramatic pause that makes it cool.


How are they modifying or returning the value of instance variables?

The getter methods can only return information, by calling method after the instance of Profile (ex: instance.gettermethodname)
 but the #change_my methods can set new information to the instance variable by setting it equal to new information (ex: instance.settermethodname = newvalue)
